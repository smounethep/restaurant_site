	...
	<?php endforeach;?>
		...
		<div class="builder-contact-field builder-contact-field-captcha">
		    ...
		    <label class="control-label" for="<?php echo $args['module_ID']; ?>-contact-captcha"><?php echo $fields_args['field_captcha_label']; ?> <span class="required">*</span></label>
					    <?php endif; ?>
		    <div class="control-input">
			<div class="themify_captcha_field g-recaptcha" data-sitekey="<?php echo esc_attr(Builder_Contact::get_instance()->get_option('recapthca_public_key')); ?>" data-ver="<?php esc_attr_e($recaptcha_version); ?>"></div>
		    </div>
		</div>
	    <?php endif; ?>
