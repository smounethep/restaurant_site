...
class Themify {
	...
	$this->media_position = themify_get('setting-search-result_media_position', 'above', true);
    ...
    function template_redirect() {
        ...
        if(is_page() || themify_is_shop()) {
            ...
            if(is_singular('portfolio')) {
                ...
                if(is_singular('post')) {
                    $this->post_layout_type=themify_get_both('post_layout', $post_meta_key.'post_layout_type', '');
                    ...
                    $this->media_position=themify_get($post_meta_key.'single_media_position', 'above', true);
                }
                $excluded_types=apply_filters('themify_exclude_CPT_for_sidebar', array('post', 'page', 'attachment', 'tbuilder_layout', 'tbuilder_layout_part', 'section'));
                $postType=get_post_type();
