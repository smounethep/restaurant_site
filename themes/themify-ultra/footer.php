...
if(themify_theme_show_area( 'footer_back' )){
    ...
    if($is_float===true || $footer_enable===true){
	    ...
	    $backTop=sprintf( '<div class="back-top tf_textc clearfix %s"><div class="arrow-up"><a aria-label="%s" href="#header"></a></div></div>'
...
<div id="footerwrap" class="tf_box tf_clear tf_textc<?php if(themify_theme_is_fullpage_scroll()):?> tf_scrollbar<?php endif;?>">
